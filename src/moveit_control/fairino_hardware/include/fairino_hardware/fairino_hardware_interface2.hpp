#ifndef _FR_HARDWARE_INTERFACE_2
#define _FR_HARDWARE_INTERFACE_2
...
class FairinoHardwareInterface2: public hardware_interface::SystemInterface{
public:
  RCLCPP_SHARED_PTR_DEFINITIONS(FairinoHardwareInterface2)
...
private:
  ...
  int _control_mode;
  std::string _controller_ip = "192.168.57.3";
