...
def main():
    ...
    try:
        ...
        if gripper.connect():
            ...
            print("\n1. 发送命令并等待运动完成:")
            gripper.send_command_with_monitoring_percent(100, 50, wait_for_completion=False)
            
            time.sleep(0.2)  # 等待一段时间以观察监视效果
            gripper.send_command_with_monitoring_percent(10, 50, wait_for_completion=False)

            # # 方法2: 手动控制监视
            # print("\n2. 手动控制监视:")
            # gripper.send_command_percent(100, 50)  # 发送命令
